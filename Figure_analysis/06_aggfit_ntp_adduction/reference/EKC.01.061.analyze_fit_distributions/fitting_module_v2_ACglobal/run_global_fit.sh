...
for rg_id in $rg_ids; do
    ...
    time python -u /projects/b1044/Computational_Output/EKC/EKC.01_SHAPE_standardization/EKC.01.061.analyze_fit_distributions/fitting_module_v2_ACglobal/timecourse_fitting.py $rg_id $glob_results_db
done